...
running(leaking) after all tests.
	...
	import "github.com/hanjm/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/hanjm/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/hanjm/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
